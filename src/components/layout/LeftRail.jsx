...
export default function LeftRail({ activeNav, onSelectNav, onHideRail }) {
  return (
    <aside className="flex h-full w-[68px] flex-col justify-between border-r border-white/8 bg-black/16 px-2 py-4 backdrop-blur-md transition-all duration-300">
      <div className="flex flex-col items-center gap-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-2xl border border-amber-300/20 bg-amber-200/10 text-lg text-amber-100">
          筑
        </div>
